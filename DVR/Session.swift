...
public class Session: NSURLSession {
    ...
    /**
     Array with the url components that will be ignored when comparing the request url with the url stored in the cassette.
     - Note: Default value is Empty
     */
    public var ignoreURLComponents: URLComponent = []
